...
main:
	...
	lea	rsi, -32[rbp] #double x
	lea	rdi, .LC1[rip] #get format string
	xor	eax, eax
	call	__isoc99_scanf@PLT #scan x
	mov	rax, QWORD PTR -32[rbp] #get x
	movq	xmm0, rax
	lea	rdi, .LC2[rip] #format string
	mov	eax, 1
	...
	mov	ebx, 1 #for int i = 1
	mov 	DWORD PTR -36[rbp], ebx
	jmp	.L3
.L4:
	movsd	xmm0, QWORD PTR -32[rbp] #xmm0 = x
